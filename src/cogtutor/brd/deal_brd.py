...
def extract_data_from_xml(file_path, target_ids, output_directory):
    ...
    for target_id in target_ids:
        ...
        action_data = {
            "id": target_id,
            "action": None,  # 初始化为 None，避免 KeyError
            "feedback": {},
            "hints": [],
            "path": []
        }
        ...
        if action_data["action"]:  # 检查 action 是否被成功设置
...
# 调用函数
file_path = 'S_6.06HTML_json/4-allison.txt'  # 指定文件路径
target_ids = ['r1c3', 'r1c4', 'r2c1', 'r2c2', 'r2c4', 'r3c1', 'r3c2', 'r3c3']  # 指定需要查找的多个 ID
